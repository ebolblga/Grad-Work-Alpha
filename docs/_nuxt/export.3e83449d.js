import{_ as x}from"./my-button.4de4b6c5.js";import{u as E}from"./composables.532695d4.js";import{t as f}from"./subjectParsing.7a17cc8c.js";import{N as g}from"./navbar.ff68e843.js";import{b as C,p as h,z as S,s as c,v as d,o as A,K as u}from"./entry.d84f6d4b.js";const T={class:"h-screen flex flex-col"},I={class:"h-[92vh] p-5 flex justify-center"},O={class:"w-[40%] flex flex-col my-auto min-w-[360px]"},$=C({__name:"export",setup(j){E({title:"Экспортировать расписание"});const o=JSON.parse(localStorage.getItem("subjectsJSON")||"");function b(){let s=`BEGIN:VCALENDAR
VERSION:2.0
