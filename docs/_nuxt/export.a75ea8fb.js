import{_ as x}from"./my-button.fb69803e.js";import{u as E}from"./composables.a945f387.js";import{t as f}from"./subjectParsing.7a17cc8c.js";import{N as g}from"./navbar.8faa1dc8.js";import{b as C,p as h,z as S,s as c,v as d,o as A,K as u}from"./entry.addd2dd0.js";const T={class:"h-screen flex flex-col"},I={class:"h-[92vh] p-5 flex justify-center"},O={class:"w-[40%] flex flex-col my-auto min-w-[360px]"},$=C({__name:"export",setup(j){E({title:"Экспортировать расписание"});const o=JSON.parse(localStorage.getItem("subjectsJSON")||"");function b(){let s=`BEGIN:VCALENDAR
VERSION:2.0
