...
<template>
    <div class="h-[8vh]">
      <div
        class="mx-auto h-full lg:w-[40vw] md:w-[90vw] flex flex-row justify-around border border-[#764462] border-t-4 border-l-0 border-r-0 border-b-0">
        <NuxtLink to="/" title="Сканировать" class="my-auto">
        <svg class="h-[5vh] fill-[#764462]" viewBox="0 0 48 48"
        ...
        <NuxtLink to="/calendar" title="Календарь" class="my-auto">
        <svg class="h-[5vh] fill-[#764462]" viewBox="0 0 48 48"
        ...
        <NuxtLink to="/export" title="Экспортировать" class="my-auto">
        <svg class="h-[5vh] fill-[#764462]" viewBox="0 0 48 48"
        :class="{ selected: ($route.name=='export') }">
          <path
        ...
        <NuxtLink to="/settings" title="Настройки" class="my-auto">
        <svg class="h-[5vh] fill-[#764462]" viewBox="0 0 48 48"
